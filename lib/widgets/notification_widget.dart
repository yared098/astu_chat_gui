...
class _NotifWidgetState extends State<NotifWidget> {
  ...
  String isPayment = " other request";
  //Creating custom Notification type Widget
  // NB: there are different type of notification

  //Friend Request Notification
  _buildReqNotif(
      {String? username, required String imgUrl, required String time}) {
    return InkWell(
      onTap: () {
        setState(() {
          isAccepted = "...";
          ...
          child: Container(
            ...
            child: Center(
              child: Text(
                btnTxt,
                style: TextStyle(
                    color: txtColor, fontSize: 18, fontFamily: "MADType"),
              ),
            ),
          ));
      ...
      child: ListTile(
        leading: Container(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
                fit: BoxFit.cover,
                image: AssetImage("assets/female1.jpeg".toString())),
          ),
        ),
        title: Padding(
          padding: const EdgeInsets.all(10),
